...
var Products = newProductsTable("merch_store", "products", "")
...
func newProductsTableImpl(schemaName, tableName, alias string) productsTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, TitleColumn, PriceColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns  = postgres.ColumnList{TitleColumn, PriceColumn, CreatedAtColumn, UpdatedAtColumn}
	)
